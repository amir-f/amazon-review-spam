...
class AmazonSpider(BaseSpider):
    ...
    def parse_product_category_page(self, response):
        ...
        """
        log.msg('Parsing products of the same category: %s' % response.meta['id'], level=log.INFO, spider=self)
    ...
    def parse_product_rev_page(self, response):
        ...
        for rev in revElems:
            ...
            review.add_value('starRating', rev.select('.//span/span[contains(@class, "swSprite")]/@title').re(star_rating_re))
    ...
    def parse_member_rev_page(self, response):
        ...
        for rev_header, rev_body in zip(rev_header_elems, rev_body_elems):
            ...
            review.add_value('starRating', rev_body.select('.//span/img[contains(@title, "stars")]/@title').re(star_rating_re))
